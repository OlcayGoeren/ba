    ...
    <Box bg="bg" safeArea h="100%">
      <Box position="relative" h="100%" display="flex" flexDirection="column" justifyContent="space-between" >
        ...
        <Box marginLeft="15" marginTop="45">
          <Heading fontSize="4xl" color="white">Willkommen in der <Text color="accent">SmartID</Text>-App</Heading>
          <Heading marginRight="23" color="text_gray" marginTop="10" fontSize="lg" >Hier können Sie herrausfinden, ob das Produkt ein gültes SmartID-Zertifikat besitzt</Heading>
        </Box>
