    ...
    return (
        <Box  accessibilityLabel='Ansicht' position="relative" h="100%" w="100%" bg="bg" safeAreaTop justifyContent="space-between">
            ...
            <Center>
                ...
                <My_Card pressed={() => navigation.navigate('Guidethrough_welcome')} title="Guidethrough" more="Vergessen wie die App funktioniert? Hier kannst du es nochmal nachlesen!" style={{mb:"6%"}}  />
                <My_Card pressed={() => navigation.navigate('Verlauf')} title="Verlauf" more="Hier kannst du alle Artikel sehen, die du bereits gescannt hast!"  style={{mb:"6%"}} />
